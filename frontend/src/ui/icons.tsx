 ...
 * All icons are 24×24 by default, scalable via width/height props.
 */
...
export const MatIcon = icon(
  <>
    <rect x="2" y="5" width="20" height="14" rx="3" fill-opacity=".15" />
    <rect x="2" y="5" width="20" height="14" rx="3" stroke="currentColor" stroke-width="1.5" fill="none" />
    <ellipse cx="12" cy="12" rx="5" ry="4" fill-opacity=".25" />
    <ellipse cx="12" cy="12" rx="5" ry="4" stroke="currentColor" stroke-width="1.2" fill="none" />
  </>,
);
